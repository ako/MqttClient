...
public class UserActionsRegistrar implements EventHandler
{
	...
	public void handleEvent(Event event)
	{
		if (event.getTopic().equals(com.mendix.core.event.EventConstants.ModelLoadedTopic()))        
		{
			...
			component.actionRegistry().registerUserAction(mqttclient.actions.MqttInitialize.class);
			component.actionRegistry().registerUserAction(mqttclient.actions.MqttPublish.class);
			component.actionRegistry().registerUserAction(mqttclient.actions.MqttSubscribe.class);
			component.actionRegistry().registerUserAction(mqttclient.actions.MqttUnsubscribe.class);
